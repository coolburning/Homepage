...
<!-- document.frm : 이름, agree:체크를 안하면 alert 출력 -->
...
<body>
	...
	<div class="container">
		...
		<h2 class="col-sm-offset-2 col-sm-9" id="bbsg">약관동의</h2>
		<form class="form-horizontal" method="post" action="createForm.jsp" onsubmit="return send()"
		name="frm">
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
			...
			<div class="form-group">
				...
				<input id="agree" type="checkbox" name="agree" value="1" ><label for="agree" id="bbsg"> 약관에 동의합니다</label>
					<!-- agree : 글씨 눌러도 체크 -->
